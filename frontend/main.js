...
signupForm.addEventListener('submit', async (e) => {
  ...
  const passwordConfirmation = document.querySelector('#signup_password_confirm').value;
  ...
  async function handleAuthResponse(response) {
    ...
    localStorage.setItem('resource_owner', JSON.stringify(data.resourceOwner));
  ...
  async function userSession() {
    ...
    if (nullOrUndefined(accessToken)) {
